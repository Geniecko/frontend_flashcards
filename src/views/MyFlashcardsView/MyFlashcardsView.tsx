...
const MyFlashcardsView: FC = () => {
  ...
  const userFlashcards = context?.flashcards.filter( flashcard => flashcard.author === context.user?.login);
  
  return (
    <>
      <ContainerTemplate secondary>
        <Headline title='Twoje fiszki' subtitle='Tutaj znajdują się wszystkie karty stworzone przez Ciebie. Możesz je usuwać lub edytować.' />
      </ContainerTemplate>
      <ContainerTemplate secondary>
